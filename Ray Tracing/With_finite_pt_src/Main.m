...
for i = 1:n
    ...
    if(theta_right<=(90-phi))
        alpha_right_up(i,1) = -abs(90 - phi - theta_right);
    elseif(theta_right>(90-phi))
        alpha_right_up(i,1) = abs(90 - phi - theta_right);
    end
   ...
   if(theta_right<=(90-phi))
        alpha_right_down(i,1) = abs(90 - phi - theta_right);
    elseif(theta_right>(90-phi))
        alpha_right_down(i,1) = -abs(90 - phi - theta_right);
    end
...
for i = 1:n_end
   ...
   if(theta_right<=(90-phi))
        alpha_right_down_botlens(i,1) = -abs(90 - phi - theta_right);
    elseif(theta_right>(90-phi))
        alpha_right_down_botlens(i,1) = abs(90 - phi - theta_right);
   end
