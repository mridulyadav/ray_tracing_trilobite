...
diff = abs(ray_i_x_up - x(1:zero_index))

[min_dist,index_min_lens_surface] = min(diff)
z(index_min_lens_surface)
...
clearvars -except X R Paraxial_focal_length t min_height max_height;
...
%dist = sqrt(((z(1:zero_index)-(ray_initial_up(i,1))).^2));
[min_dist,index_min_lens_surface] = min(diff)
z(index_min_lens_surface)
ray_final_up(i,1) = z(index_min_lens_surface)
ray_final_up(i,2) = ray_initial_up(i,2);
...
ray_final_index_down_orignl = ray_final_index_down;
ray_final_index_up_orignl = ray_final_index_up; 
 ...
 for ctr=1:3
     ...
     ray_final_index_down = ray_final_index_down_orignl;
     ray_final_index_up = ray_final_index_up_orignl;
